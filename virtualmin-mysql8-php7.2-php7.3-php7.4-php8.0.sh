...
#PHP Install
apt install php7.2-{cli,pdo,fpm,zip,gd,xml,mysql,cgi} php7.3-{cli,pdo,fpm,zip,gd,xml,mysql,cgi} php7.4-{cli,pdo,fpm,zip,gd,xml,mysql,cgi} php8.0-{cli,pdo,fpm,zip,gd,xml,mysql,cgi} -y
#PHP Install
