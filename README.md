...
```
apt install -y $(apt-cache search --names-only '^php8.3-' | awk '{print $1}' | grep -v -E '^(php8.3-gmagick|php8.3-yac|php8.3-ds|php8.3-sass|php8.3-uopz|php8.3-xdebug|php8.3-tideways)') 2>&1 | tee /var/log/php8.3-install.log
```
```
phpdismod ds
phpdismod sass
